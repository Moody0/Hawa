...
import { MdAdd, MdRemove, MdShoppingBag } from "react-icons/md";
            ...
            <div className="flex items-center justify-between sm:justify-end gap-4 shrink-0 pt-2 sm:pt-0 border-t sm:border-t-0 border-gray-100 dark:border-white/5">
                ...
                <div>
                    {quantityInCart === 0 ? (
                        ...
                        <div className="flex items-center gap-2 bg-[#FAF6EC] dark:bg-[#8A6305]/20 border border-[#8A6305]/30 rounded-xl px-2 py-1">
                            <button
                                type="button"
