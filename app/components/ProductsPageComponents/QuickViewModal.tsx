                ...
                <div className="flex-1 p-5 sm:p-6 md:p-8 flex flex-col justify-center order-2 md:order-1">
                    ...
                    <div className="flex flex-col gap-1.5 mb-4 bg-[#FAF6EC] dark:bg-zinc-800/80 p-3 rounded-xl border border-[#8A6305]/25">
                        <div className="flex items-center justify-between text-xs">
                            ...
                            <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-[#2E7D32]/10 text-[#2E7D32]">
                                {language === 'ar' 
                    ...
                    <div className="mb-5">
                        {!product.hidePrice && Number(product.price) > 0 ? (
                            <div className="text-2xl font-extrabold text-[#0B192C] dark:text-white">
                    ...
                    <div className="flex items-center gap-3 sm:gap-4 mb-4">
                        <button 
                            ...
                            className="flex-1 bg-[#2E7D32] hover:bg-[#256628] text-white py-3 rounded-xl font-bold transition-all text-xs sm:text-sm cursor-pointer shadow-xs active:scale-[0.98]"
                        >
