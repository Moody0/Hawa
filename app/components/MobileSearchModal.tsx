...
const FEATURED_AGENCIES = [
    { nameAr: 'بوفالو', nameEn: 'Bufalo', slug: 'bufalo' },
    { nameAr: 'حليبنا', nameEn: 'Halibna', slug: 'halibna' },
    { nameAr: 'الريف', nameEn: 'Alreef', slug: 'alreef' },
    { nameAr: 'روكافيرا', nameEn: 'Rocavera', slug: 'rocavera' },
    { nameAr: 'زوان', nameEn: 'Zwan', slug: 'zwan' },
    { nameAr: 'صن بيل', nameEn: 'Sun Bell', slug: 'sun-bell' },
