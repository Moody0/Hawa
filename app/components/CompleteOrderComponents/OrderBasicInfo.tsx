...
const OrderBasicInfo = ({ orderNumber, totalAmount, isQuoteRequest = false }: OrderBasicInfoProps) => {
    ...
    return (
        <div className="p-6 sm:p-8 border-b border-gray-200 dark:border-white/10 grid grid-cols-1 md:grid-cols-3 gap-6 text-center md:ltr:text-left md:rtl:text-right bg-gray-50/50 dark:bg-zinc-800/40">
            <div className="flex flex-col gap-1 items-center md:items-start">
                ...
                <p className="text-base sm:text-lg font-bold text-[#0B192C] dark:text-[#8A6305] truncate"><span dir="ltr">{formatOrderNumber(orderNumber)}</span></p>
            </div>
            <div className="flex flex-col gap-1 items-center md:items-start">
