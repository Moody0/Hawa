...
## 2026-09-08T13:06:16Z
You are the Project Orchestrator for the Hawa B2B platform remediation project.

Your working directory is: E:\work\hawa\.agents\orchestrator_1
The project root is: E:\work\hawa
The authoritative user request is in: E:\work\hawa\.agents\ORIGINAL_REQUEST.md
The audit remediation plan is in: E:\work\Hawa\new\WEBSITE_AUDIT_REMEDIATION_PLAN_V2.md

## Communication & Language
- Output all responses, explanations, and commit/documentation commentary strictly in English.
...
Complete the remaining implementation tasks from E:\work\Hawa\new\WEBSITE_AUDIT_REMEDIATION_PLAN_V2.md executing work in strict order: security & data integrity edge-cases first, admin correctness second, operational UX/accessibility third, and automated release gates last.

## Requirements:
1. R1. Admin UX, Modals & Accessibility Overhaul (Phase 4):
   - Create shared, accessible confirmation dialog component (<AccessibleConfirmDialog />) with initial focus trap, Escape key handling, and focus restoration.
   - Replace all native window.confirm() calls across all 10 admin client files:
     * BannersClient.tsx
   ...
   - Ensure all interactive touch targets meet the 44x44 px minimum and table headers feature accessible sorting buttons with aria-sort.

2. R2. Admin Data Management & Scalable Pagination (Phase 3):
...
3. R3. Storefront & Cart Edge Cases (Phase 2 & Phase 6):
...
4. R4. Automated Quality Gate & Clean Linting (Phase 7):
